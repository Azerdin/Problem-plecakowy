...
class CreateWektorTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('wektors', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->unsignedInteger('kurier_id')->nullable(false);
            $table->foreign('kurier_id')->references('id')->on('kuriers');
